...
df <- c(7, 14, 18, 25, 29, 25, 33, 37, 43)
hist(df, xlab = "Number of deaths", main = "")

pnorm(36, mean = 36, sd = 5)
pnorm(40, mean = 36, sd = 5) - pnorm(30, mean = 36, sd = 5) 
pnorm(26, mean = 26, sd = 11.39)
...
extrmPov <- c(81, 70, 82, 50, 5, 45, 40, 7, 25, 4)
smartPh <- c(10, 20, 30, 40, 6, 49, 71, 73, 95, 99)

plot(smartPh, extrmPov, xlab="% population owning a smartphone", ylab = "% population living on < $1.90 per day")
plot(extrmPov, smartPh)
